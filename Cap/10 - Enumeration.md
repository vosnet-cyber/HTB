...
## Services
FTP and a webserver are going to be interesting. SSH there too, but maybe this will come into play a bit later

### FTP
Anonymous failed to work:
```bash
...
### Webserver
Web page is a system monitoring tool by looks of it:
![[Pasted image 20210725173858.png]]

Displays one username "Nathan" will keep that in mind.
